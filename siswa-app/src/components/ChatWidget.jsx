...
export default function ChatWidget({ role, userId }) {
  ...
  const getOpponent = (chat) => {
    if (role === "siswa") {
      ...
      return { name: chat.siswa_name || "Siswa", avatar: chat.siswa_avatar, unread: chat.unread_guru || 0, subtitle: `Booking ID: ${chat.booking_id}` };
    }
  };
        ...
        <div style={{
          ...
          <div style={{ padding: "14px 20px", background: "#185FA5", color: "#fff", display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div style={{ flex: 1, fontWeight: 700, fontSize: 15 }}>
              {activeChat ? getOpponent(activeChat).name : "Pesan"}
            </div>
            ...
            {!activeChat ? (
              ...
              chats.length === 0 ? (
                <div style={{ padding: 40, textAlign: "center", color: "#aaa", fontSize: 13 }}>
                  Belum ada pesan.<br/>Mulai sesi booking untuk chatting!
                </div>
              ) : (
                chats.map(chat => {
